...
public class IntegerToWords {
    ...
    public static void main(String[] args) {
        System.out.println(intToWords(22));
        System.out.println(intToWords(34982683));

    }

    static String intToWords(Integer num) {
        // if (num == 0)
        //     return "Zero";
        ...
        // num /= 1000;
        // if (num > 0 && num % 1000 > 0) {
        //     result = numberToWord(num % 1000) + " Hundred " + result;
        // }

        // num /= 1000;
        // if (num > 0 && num % 1000 > 0) {
        //     result = numberToWord(num % 1000) + " Million " + result;
        // }

        // num /= 1000;
        // if (num > 0) {
        //     result = numberToWord(num % 1000) + " Billion " + result;
        // }
